...
### Ссылки
- [Исходники](https://github.com/lisisty/test-hitmaster)

# Lightweight Tower
Типичный TD со всеми возможностями присущими жанру в приятной lowpoly стилистике.

### Изображения
<img width=400 align="left" src="https://github.com/lisisty/dev/blob/master/LastTower/screenshots/gameplay.gif?raw=true"/>
<img width=400 src="https://github.com/lisisty/dev/blob/master/LastTower/screenshots/ui2.gif?raw=true"/>
...
- [Примеры кода](https://github.com/lisisty/dev/tree/master/LastTower/code_samples)
- [Скрины редактора](https://github.com/lisisty/dev/tree/master/LastTower/unity)



# Glass Walls
Расслабляющая гиперказуалка с незамысловатым геймплеем с упором на визуал и звуки.
...
# WowSnow VR
Симулятор катания на снегоходе по заснеженному лесу для Oculus Go. Использование контроллера в качестве руля.

### Изображения
<img width=400 align="left" src="https://github.com/lisisty/dev/blob/master/WowSnow/2560x1440.jpg?raw=true"/>
...
# OneLevel Demo
"Проба пера" в пиксельарт платформере.
...
<img width=400 src="https://github.com/lisisty/dev/blob/master/OneLevel/4.gif?raw=true"/>



# ARRoom
Сервис в который можно загрузить любую 3D модель в формате GLTF (например из скетчфаба) и вывести ее в дополненную реальность. Есть возможность шаринга своей модели с друзьями.

### Изображения
<img height=400 align="left" src="https://github.com/lisisty/dev/blob/master/ARRoom/2022-01-14%2017.41.20.png?raw=true"/>
...
### Библиотеки
- ARCore для AR
- GLTFUtility для работы с форматов GLTF
- ZXing для генерации\распознавания QR-кодов
- SharpZipLib для распаковки\упаковки в zip
- NativeGallery для выдергивания изображений из галереи
- SimpleFileBrowser для выдергивания файлов из фс
...
# LooksLike
Концепт сервиса по поиску двойников

### Изображения
<img height=400 align="left" src="https://github.com/lisisty/dev/blob/master/LooksLike/2022-01-14%2012.43.34.png?raw=true"/>
<img height=400 align="left" src="https://github.com/lisisty/dev/blob/master/LooksLike/2022-01-14%2012.44.20.png?raw=true"/>
<img height=400 src="https://github.com/lisisty/dev/blob/master/LooksLike/2022-01-14%2012.42.53.png?raw=true"/>
